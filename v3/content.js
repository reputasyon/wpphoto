// WPPhoto v3 - Content Script (WhatsApp Web)
...
if (window.__wpphoto_loaded) {
  ...
  async function switchToChatViaSearch(contactName) {
    ...
    for (let i = 0; i < 10; i++) { // CHAT_SWITCH_MAX
      ...
      if (nowChat && nowChat !== prevChat) {
        ...
        // v3: Stricter chat name verification
        ...
        // Substring match requires minimum length to prevent short-name false positives
  ...
  console.log('[WPPhoto] Content script v3.0.0 loaded');
}
