// WPPhoto v5 - Entry point, wires everything together
WP.app = {
  ...
  async loadCategories() {
    ...
    try {
      ...
      document.getElementById('scanner-tabs').classList.remove('hidden');
      ...
      WP.contactScanner.populateCategorySelect();
      WP.contactScanner.loadSettings();
...
// Save excluded labels on blur
document.getElementById('contact-scanner-excluded-labels').addEventListener('change', () => WP.contactScanner.saveExcludedLabels());
